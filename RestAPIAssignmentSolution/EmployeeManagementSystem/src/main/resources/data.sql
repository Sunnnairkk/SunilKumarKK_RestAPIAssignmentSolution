...
insert into employee (id, first_name, last_name, email) values (1, 'vivek', 'sharma', 'vs@gmail.com');
insert into employee (id, first_name, last_name, email) values (2, 'usertemp', 'tempuser', 'email@gmail.com');
insert into employee (id, first_name, last_name, email) values (3, 'great', 'learning', 'gl@gmail.com');
